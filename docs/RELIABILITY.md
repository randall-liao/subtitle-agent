...
## Observability
All CLI interactions are logged via `loguru`. During runs, success/failure ratios are aggregated at the very end of the autonomous session and presented as a final summary report:
